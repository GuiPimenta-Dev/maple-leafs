...
class NhlMapleLeafsSpider(scrapy.Spider):
    name = "nhl-maple-leafs"
    page = 1
    start_urls = [
        "https://www.nhl.com/mapleleafs/news/search-articles?page=1&tid=277568014"
    ]
    ...
    def parse(self, response):
        ...
        if articles:
            self.page += 1
            next_page = f"https://www.nhl.com/mapleleafs/news/search-articles?page={self.page}&tid=277568014"
